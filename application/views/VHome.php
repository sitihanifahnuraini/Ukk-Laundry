			...
			<div class="col-md-12">
				...
				foreach ($data as $d) :?>
					<tr>
						...
						<td align="center">
							<a href="<?php echo site_url('App_controler/CEditMember/'.$d['id_member']) ?>" class="btn btn-warning">Edit </a>
							<a href="<?php echo site_url('App_controler/CHapusMember/' . $d['id_member']) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus')"> Hapus</a>
						</td>
					</tr>
				<?php endforeach ?>
				</tbody>
