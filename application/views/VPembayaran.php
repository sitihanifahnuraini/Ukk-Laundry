                    ...
                    foreach ($data as $d) :?>
                        <tr>
                            ...
                            <?php if ($d['status_pembayaran'] != 'dibayar') :?>
                                <a href="<?php echo site_url('App_controler/CProsesTampilPembayaran/'.$d['id_transaksi']) ?>" class="btn btn-outline-success"> Bayar </a>
                                <a href="<?php echo site_url('App_controler/CHapusPembayaran/'.$d['id_transaksi']) ?>" class="btn btn-outline-success" onclick="return confirm('Yakin ingin menghapus')"> Hapus </a>
                            <?php endif ?>
                            ...
                            <?php if (($d['status_pembayaran'] == 'dibayar') && ($d['status_transaksi'] != 'diambil') && ($d['status_transaksi'] != 'proses')):?>
                                <a href="<?php echo site_url('App_controler/CProsesTampilPengambilan/'.$d['id_transaksi']) ?>" class="btn btn-outline-success"> Ambil </a>
                            <?php endif ?>
                            </td>
                        </tr>
                    <?php endforeach ?>
